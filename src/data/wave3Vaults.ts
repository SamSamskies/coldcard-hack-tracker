 ...
 * Watch list: vaults ≥ 0.5 BTC only (79 · 191.31550839 BTC) for reliable snapshots.
...
export const WAVE3_VAULTS = [
  ...
  },
  {
    ...
    pollBalance: false,
    note: 'Emptied Sep 4 (block 965625, ~2 sat/vB): → Taproot hop [bc1pacpd…](address:bc1pacpd74fkvvxelcqtrc9zy8aevxlrvwj2mfe3wv9tn8a4jfmfyraqvekg6w) → coinjoin (block 965632, 144→159). Snapshot already 0 before Galaxy’s Sep 7 ranks 1–11 note. [Galaxy](https://x.com/glxyresearch/status/2096785347929608296).',
  },
  {
    ...
    pollBalance: false,
    note: 'Emptied Sep 6 (block 965850, ~4 sat/vB): co-spent with Wave 3 ranks 3–11 + open vault [bc1q5lxd8…](address:bc1q5lxd8nwhptgt59n46a33udsjp2ghjw3n2kerpguvwqzah8deg5ls4rf2sl) → Taproot hop [bc1p7xunc…](address:bc1p7xunc8vxs9g3z3kv7yqkjsza9aephe5m73ynwdqg78m9kj0va3qq6akw44) (~61.12 BTC) → coinjoin (block 965854, 206→273). [Galaxy](https://x.com/glxyresearch/status/2096785347929608296).',
  },
  {
  ...
  {
    address: 'bc1q5lxd8nwhptgt59n46a33udsjp2ghjw3n2kerpguvwqzah8deg5ls4rf2sl',
    label: 'Wave 3 vault 6 (Galaxy open co-spend)',
    reportBtc: 6.34184638,
    pollBalance: false,
    note: 'Galaxy Sep 7: previously “cause = open” 2-of-2 (58 victim inputs, block 960829, ~201 sat/vB) co-spent with Wave 3 ranks 3–11 into Taproot hop → coinjoin. Likely CC victim; would make Wave 3 294 vaults / published total ~1806 BTC if promoted. [Galaxy](https://x.com/glxyresearch/status/2096785369043784085).',
  },
  {
    ...
    pollBalance: false,
    note: '[Chainabuse victim](https://chainabuse.com/report/0f8d1d1c-556b-40e6-a819-c91c153497aa) · ~5.39 BTC Mk3 drain ([park](address:bc1q4626d9knltp3eeuwmfhuqh4ez3py4rdq9nsck8) → this vault). Emptied Sep 6 (block 965850, ~4 sat/vB): co-spent with Wave 3 ranks 3–11 + open vault [bc1q5lxd8…](address:bc1q5lxd8nwhptgt59n46a33udsjp2ghjw3n2kerpguvwqzah8deg5ls4rf2sl) → Taproot hop [bc1p7xunc…](address:bc1p7xunc8vxs9g3z3kv7yqkjsza9aephe5m73ynwdqg78m9kj0va3qq6akw44) (~61.12 BTC) → coinjoin (block 965854, 206→273). [Galaxy](https://x.com/glxyresearch/status/2096785347929608296).',
  },
  {
    ...
    pollBalance: false,
    note: '[Chainabuse victim](https://chainabuse.com/report/2727f906-bf8f-4540-92e4-ad4fd5b59cbf) · Mk3 drain ([park](address:bc1qz09phmghykhcglwhc58uf95mmjqq8vz4wmhz4v) → this vault). Emptied Sep 6 (block 965850, ~4 sat/vB): co-spent with Wave 3 ranks 3–11 + open vault [bc1q5lxd8…](address:bc1q5lxd8nwhptgt59n46a33udsjp2ghjw3n2kerpguvwqzah8deg5ls4rf2sl) → Taproot hop [bc1p7xunc…](address:bc1p7xunc8vxs9g3z3kv7yqkjsza9aephe5m73ynwdqg78m9kj0va3qq6akw44) (~61.12 BTC) → coinjoin (block 965854, 206→273). [Galaxy](https://x.com/glxyresearch/status/2096785347929608296).',
  },
  {
  ...
  },
  {
    ...
    label: 'Wave 3 vault 79',
    reportBtc: 0.50163823,
  },
] as const;

export const WAVE3_VAULT_COUNT = 79 as const;
export const WAVE3_VAULT_REPORT_BTC = 191.31550839;
