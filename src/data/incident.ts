...
export const SOURCES = [
  ...
  {
    label: 'Izautrin / MadMike · independent RNG audit',
    note: 'Sep 6 public repo ([coldcard-rng-audit](https://github.com/izautrin/coldcard-rng-audit); [r/Bitcoin](https://www.reddit.com/r/Bitcoin/comments/1w91wk3/i_reconstructed_the_coldcard_rng_losses_onchain/)): claims ~2,052 recovered Mk3 seeds → 35,189 drained addrs; **net ~5,080 BTC** / gross ~10,951 after change-cycling; ~2,918 BTC still on attacker hubs / ~991 to exchanges; sweeper still active (last noted drain Aug 19). Argues Galaxy/BlockSec measured mainly the Jul–Aug 2026 tip while seed recovery also surfaces years of quieter activity. Partial on-chain corroboration: hub map includes known Jul 2026 consolidations we watch (e.g. [bc1qnk4zh…](address:bc1qnk4zh9qcnap2mycp56qjrgza3cc8ylrh8fecp0) ~562 BTC Wave 1 sink; Wave 2 collector [bc1qsjrf5…](address:bc1qsjrf5ze5tmulz7y2x4pc7qaex2a35sanp3rqlx)); sample victim [bc1q52g7…](address:bc1q52g7pwd048w96x5q8ypyxaz62jfl26v3y3rhgc) funded May 2021 and swept in block 960359 (Galaxy Wave 2 window). Early same-block “drains” can be owner change-cycling within one seed (e.g. wallet #2 addrs in May 2021) — their net figure depends on unpublished TX-graph classification. **Not folded into our Galaxy headlines** — seed recovery / net graph not independently reproduced here; entropy claim (~19–20 bits vs BlockSec ~2^40.69 / Coinkite ~72-of-128 wording) is a different measurement; their “Galaxy = 2,055 Jul 30 only” table understates later Aug 24 established 1,789.28 / candidates ~2,447. Treat as unverified broader-population estimate pending LE/Galaxy review. No seeds or PRNG params in the public package.',
    url: 'https://github.com/izautrin/coldcard-rng-audit',
  },
  {
