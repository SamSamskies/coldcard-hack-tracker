...
8. **Cash-outs / labels** — when vaults empty or hops hit exchanges/bridges, follow **[cashout-labeling](../cashout-labeling/SKILL.md)** (holding vs label-only, Arkham primary / OKLink secondary / Bithypha tertiary for unlabeled hops, `KNOWN_ADDRESS_LABELS`).
