...
6. **Proactive new-wave scout** — when hunting unreported waves (not a named Galaxy/community claim), follow **[new-wave-scan](../new-wave-scan/SKILL.md)** (`scripts/scan-new-waves.py`) before inventing fingerprints.
